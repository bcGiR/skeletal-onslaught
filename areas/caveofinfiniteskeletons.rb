	...
	def initialize(game)
		super("Cave of Infinite Skeletons",
		      [ entrance = Area.new( "Cave of Infinite Skeletons: entrance", #entrance_name
					     ...
					     [ HealthPot.new ] ), #entrance_objects
		      ...
		      a2 = Area.new( "North Barrack", #a2_name
				    ...
				    [HealthPot.new, ManaPot.new] ), #a2_objects
		      ...
		      b2 = Area.new( "South Barrack", #b2_name
				    ...
				    [HealthPot.new, ManaPot.new] ), #b2_objects
		      ...
		      final = Area.new( "Final", #final_name
					 ...
					 Proc.new { @game.spawn_enemy("zombie", -1) }], #final_enemies
				       [HealthPot.new, HealthPot.new, HealthPot.new] ), #final_objects
		      lair = Area.new( "Skelethognos' Lair", #lair_name
					...
					[HealthPot.new, HealthPot.new, ManaPot.new] ) ], game ) #lair_objects
